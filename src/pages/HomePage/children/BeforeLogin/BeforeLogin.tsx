    ...
    return (
        <div className="flex justify-center items-center">
            <div className="w-[500px] h-[351px] mr-[64px]">
                <p className="font-inter font-semibold text-[24px] leading-[28.8px] text-[#EC221F]">Welcome!</p>
                <p className="font-inter font-bold text-[20px] leading-[24px] text-[#1E1E1E] mt-[12px] mb-[16px]">Student Smart Printing Service (HCMUT_SSPS)</p>
