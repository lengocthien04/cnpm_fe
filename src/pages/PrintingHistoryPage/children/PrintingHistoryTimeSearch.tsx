...
export default function PrintingHistoryTimeSearch() {
  ...
  return (
    <div className="flex flex-row gap-[2rem] justify-start items-center py-[3rem] pl-[3rem]">
      ...
      <button
        type="submit"
        className="border-[0.1rem] rounded-[1rem] px-[0.8rem] py-[0.4rem] h-[3.2rem] bg-button-color shadow-[1rem] text-white text-[1.4rem]"
      >
        Tìm kiếm
      </button>
    </div>
